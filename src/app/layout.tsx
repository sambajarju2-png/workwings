...
export const metadata: Metadata = {
  ...
  appleWebApp: { capable: true, statusBarStyle: "black-translucent", title: "WorkWings" },
  openGraph: {
    ...
    type: "website", locale: "nl_NL", url: "https://workwings.nl", siteName: "WorkWings",
  },
  twitter: { card: "summary_large_image", title: "WorkWings — Freelance Shifts in Nederland", description: "Vind shifts in horeca, retail, logistiek en events. Direct betaald." },
